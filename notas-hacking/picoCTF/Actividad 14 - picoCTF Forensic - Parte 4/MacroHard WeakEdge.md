...
## Solución
Con la terminal de Kali Linux, la bandera se encuentra en el directorio ppt/slidemasters en el archivo hidden
```
...
--2025-04-28 17:57:18--  https://mercury.picoctf.net/static/3944a59474f9f676942282c50b9c3675/Forensics%20is%20fun.pptm
...
Forensics is fun.pptm                     100%[===================================================================================>]  97.75K   569KB/s    in 0.2s    

2025-04-28 17:57:19 (569 KB/s) - ‘Forensics is fun.pptm’ saved [100093/100093]
...
[main 2025-04-28T23:57:47.816Z] update#setState disabled
[main 2025-04-28T23:57:47.823Z] update#ctor - updates are disabled as there is no update URL
[75862:0428/175748.458082:ERROR:command_buffer_proxy_impl.cc(128)] ContextResult::kTransientFailure: Failed to send GpuControl.CreateCommandBuffer.
^C[main 2025-04-28T23:58:40.286Z] Extension host with pid 75938 exited with code: 0, signal: unknown.
...
┌──(kali㉿kali)-[~/Documents/srss/forensic]
└─$ echo -n "Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q" | tr -d " " | base64 -d
