...
## Solución
Copiar el contenido de la conexión de ese puerto y usar CyberChef para decodificarla usando la palabra flag como key
```
Encrypted message:
...
### Referencias
https://youtu.be/ACVSzc-wH8o?si=eNV-sJvKE3TMUmX4https://youtu.be/ACVSzc-wH8o?si=eNV-sJvKE3TMUmX4
